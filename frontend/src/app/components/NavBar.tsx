...
export default function NavBar() {
    ...
    const handleNewChat = () => {
        window.location.href = '/'; // force re-render server components + reset state
    };
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                        ...
                        <button
                            ...
                            className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg text-sm sm:text-base transition-colors ${pathname === '/'
